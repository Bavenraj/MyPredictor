...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  }else{    $_SESSION["buildingType"] = $buildingType;}
?>
<!DOCTYPE html>
<html lang="en">
    ...
    <div class="container">
      <div class="row gy-1 d-flex justify-content-between">
        <div class="col-lg-6 order-2 order-lg-1 d-flex flex-column justify-content-center" style="width:100%;">
          ...
          <p data-aos="fade-up" data-aos-delay="100" style="font-size : 30px; margin-left:80px;"><?php echo $_SESSION["state"]." \ " .  $_SESSION["area"] . " \ " . $_SESSION["buildingType"] ?></p>
          ...
          <form action="predictprice3.php" method="post">
            <div style="margin-left:80px; margin-top:50px;font-size:24px;">What type of ownership is it?</div>
            <div class="radio-tile-group1">
                  <div class="input-container1">
                    <input id="freehold" type="radio" name="tenure" value="Freehold" required>
                  ...
                  <div class="input-container1">
                    <input id="leasehold" type="radio" name="tenure" value="Leasehold">
                    <div class="radio-tile1">
            ...
            <div>
              <div class="button-tile-group">
                <div class="button-container">
                  ...
                  <a href="predictprice1.php" onclick="predictprice1();">Back</a>
                  </div>
                </div>
                <div class="button-container">
                  <div class="button-tile">
